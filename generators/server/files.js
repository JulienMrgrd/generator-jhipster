...
function writeFiles() {
    return {
        ...
        writeServerJavaWebFiles() {
            ...
            if (this.reactive !== 'no') this.template(`${SERVER_MAIN_SRC_DIR}package/web/rest/util/_AsyncUtil.java`, `${javaDir}web/rest/util/AsyncUtil.java`);
        ...
        writeJavaUserManagementFiles() {
            ...
            if (this.databaseType === 'sql' || this.databaseType === 'mongodb') {
                // TODO: this.template(`${SERVER_TEST_SRC_DIR}package/repository/_CustomAuditEventRepositoryIntTest.java`, `${testDir}repository/CustomAuditEventRepositoryIntTest.java`);
